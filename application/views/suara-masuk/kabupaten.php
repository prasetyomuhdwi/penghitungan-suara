						...
						<div class="card-body">
							<table width="100%">
								<tr>
									...
									<td>
										<a href="<?= base_url('cetak/kecamatan/d') ?>" target="_blank" class="btn btn-success float-right"><i class="fa fa-print"></i> Cetak</a>
							...
							<div class="table-responsive mt-3">
								<table id="kabupatenTable" class="table table-bordered table-striped">
									<thead class="text-center">
										<tr>
											<th class="align-middle" rowspan="2">No</th>
											<th class="align-middle" rowspan="2">Nama Kecamatan</th>
									...
									<tbody>
										...
										<?php foreach ($hasil_sah as $h) : ?>
											<tr>
												...
												<td class="text-center">
													<a href="<?= base_url('suara-masuk/kecamatan/') . $h['id'] ?>" class="btn btn-warning"><i class="fa fa-search"></i></a>
												</td>
											</tr>
											<?php $i++; ?>
										<?php endforeach; ?>
